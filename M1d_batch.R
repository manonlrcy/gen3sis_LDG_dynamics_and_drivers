...
apply_ecology <- function(abundance, traits, landscape, config) {
  ...
  # define carrying capacity, K: This is a constant or a parameter that represents the carrying capacity of the environment, i.e., the maximum population size that the environment can support.
  P = precip_site
  H = hydro_site
  area = area_site
